...
class EmailsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> EmailsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/ai-inbx-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> EmailsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/ai-inbx-python#with_streaming_response
        """
