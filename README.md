...
```sh
# install from the production repo
pip install 'ai_inbx[aiohttp] @ git+ssh://git@github.com/aiinbx/aiinbx-py.git'
```
...
These methods return an [`APIResponse`](https://github.com/aiinbx/aiinbx-py/tree/main/src/ai_inbx/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/aiinbx/aiinbx-py/tree/main/src/ai_inbx/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
